...
def build_parser() -> argparse.ArgumentParser:
    ...
    shrink_p.add_argument('--input', '-i', default='./data/source', help='Input json directory.')
    shrink_p.add_argument('--output', '-o', default='./data/temps/12/Shrinked', help='Output json directory.')
    ...
    convert_p.add_argument('--input', '-i', default='./data/temps/12/Shrinked', help='Input json directory.')
    convert_p.add_argument('--output', '-o', default='./data/temps/12/Spotted', help='Output json directory.')
    ...
    png_p.add_argument('--input', '-i', default='./data/temps/12/Spotted', help='Input json directory.')
    png_p.add_argument('--output', '-o', default='./data/temps/12/GT', help='Output png directory.')
    ...
    viz_p.add_argument('--image', '-i', default='./data/source', help='Input image file or directory.')
    viz_p.add_argument('--mask', '-m', default='./data/temps/12/GT', help='Mask png file or directory.')
    viz_p.add_argument('--output', '-o', default='./data/temps/12/Vis', help='Output file or directory.')
    ...
    run_p.add_argument('--input', '-i', default='./data/source', help='Input image/json directory.')
    run_p.add_argument('--output', '-o', default='./data/temps/12', help='Output base directory.')
